...
from openedx_learning.apps.openedx_content.applets.backup_restore.zipper import (
    LearningPackageUnzipper,
    generate_staged_lp_key,
)
from openedx_learning.apps.openedx_content.applets.collections import api as collections_api
...
class RestoreLearningPackageCommandTest(RestoreTestCase):
    ...
    @patch("openedx_learning.apps.openedx_content.applets.backup_restore.api.load_learning_package")
...
class RestoreLearningPackageTest(RestoreTestCase):
    ...
    def test_error_learning_package_missing_key(self):
        ...
        with patch(
            "openedx_learning.apps.openedx_content.applets.backup_restore.zipper.parse_learning_package_toml",
            return_value={
                "learning_package": {
                    "title": "Library test",
                    "description": "",
